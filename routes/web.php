...
Route::middleware("auth")->group(function() {
    ...
    Route::middleware(['is_operator'])->group(function () {
        ...
        Route::put('/dashboard/mahasiswa/edit/save/{id}', [MahasiswaController::class, "editMahasiswa"])->name("update_mahasiswa");
        Route::get('/dashboard/mahasiswa/new', [MahasiswaController::class, "formNew"])->name("form_new_mahasiswa");
        Route::post('/dashboard/mahasiswa/new/save', [MahasiswaController::class, "newMahasiswa"])->name("new_mahasiswa");
    ...
    Route::get('/dashboard/jawaban/isi/tugas/{id}', [JawabanController::class, "formNew"])->name("isi_jawaban");
    Route::post('/dashboard/jawaban/isi/save', [JawabanController::class, "newJawaban"])->name("new_jawaban");
    Route::delete('/dashboard/jawaban/delete/{id}', [JawabanController::class, "deleteJawaban"])->name("delete_jawaban");
    Route::get('/dashboard/jawaban/tugas/{id}', [JawabanController::class, "showJawabanTugas"])->name("show_jawaban_tugas");
    ...
    Route::get('/dashboard/tugas/new/{id}', [TugasController::class, "formNew"])->name("form_new_tugas");
    ...
    Route::get('/dashboard/kelas/detail/{id}', [Anggota_kelasController::class, "showDetail"])->name("show_detail_kelas");
    Route::post('/dashboard/kelas/join', [Anggota_kelasController::class, "findKelas"])->name("join_kelas");
